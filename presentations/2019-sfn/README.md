...
* **Statistical Modeling and Feature Extraction:** Designed and implemented a comparative analysis pipeline to evaluate neural and behavioral differences based on biomarker presence, utilizing **R** to develop cross-sectional multivariate mixed-effects regressions and longitudinal trajectory models and to extract individual participant slopes as engineered features, followed by voxel-based morphometry (VBM) neuroimaging analyses in **MATLAB**.
...
**Keywords:** *Magnetic Resonance Imaging (MRI), Positron Emission Tomography (PET), Voxel-Based Morphometry (VBM), Structural Neuroimaging, Mixed-Effects Regression, Feature Extraction, Feature Engineering, Longitudinal Behavioral Modeling, Multivariate Linear Regression, Cohort Stratification, Gray Matter Volume, Hippocampus, Multimodal Integration, Alzheimer's Disease, Amyloid-β, Apolipoprotein ɛ4 (APOE\*E4), Biomarker, Preclinical Marker, Neurodegenerative Disorder, Social Cognition, Emotional Empathy, Interpersonal Reactivity Index (IRI)*
